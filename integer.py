...
# Ensure there will not be any errors if a non-integer value is entered for hours or rate.
while True:
  try:
    ...
    print("Please enter a valid number before this computation can be completed.")
